...
An installable Progressive Web App (PWA) for Vcams attendance tracking via QR-based check-in, with a torch (flashlight) toggle, built with Vue 3, Vuetify 3, TypeScript, and Vite. Works offline after first load and persists scan history in IndexedDB.
